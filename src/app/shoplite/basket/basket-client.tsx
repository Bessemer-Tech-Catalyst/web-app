 ...
 *
 * The session check is not here. It is in `page.tsx`, on the server, because a guard that
 * runs after the page has already rendered is not a guard — see the note there.
 */
